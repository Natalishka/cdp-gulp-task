...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.transformString = exports.createUserObject = undefined;

	var _modification_array = __webpack_require__(9);

	var _modification_string = __webpack_require__(12);

	exports.createUserObject = _modification_array.createUserObject;
	exports.transformString = _modification_string.transformString;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function transformString(str) {
	    var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'upper';

	    if (_lodash2.default.isString(str)) {
	        return action == 'upper' ? str.toUpperCase() : str.toLowerCase();
	    }
	}
